...
<main class="container">
    ...
    <div class="min-h-screen relative flex justify-center items-center bg-white">
        <div class="p-10 border-[1px] -mt-10 border-slate-200 rounded-lg flex flex-col items-center space-y-3">
            <input class="text-center p-3 border-[1px] border-slate-500 rounded-md w-80" placeholder="Username" />
            <div class="flex flex-col space-y-1">
                <input class="text-center p-3 border-[1px] border-slate-500 rounded-md w-80" placeholder="Password" />
            </div>
            <div class="flex flex-col space-y-5 w-full">
                <button class="w-full bg-almost-white rounded-3xl border border-almost-black p-3 text-almost-black font-bold">Log in</button>
                ...
                <button class="w-full border-almost-black hover:border-[2px] border-[1px] rounded-3xl p-3 text-almost-black font-bold">Sign Up</button>
            </div>
        </div>
    </div>
    <!-- Footer -->
